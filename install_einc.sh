...
export CFLAGS="-fopenmp -DMKL_ILP64 -m64"
export CUDAFLAGS="-fopenmp"

export OMP_NUM_THREADS=4
export CXXFLAGS="-fopenmp -DMKL_ILP64 -m64"

export CPPFLAGS="-fopenmp -DMKL_ILP64 -m64"
...
export Boost_INCLUDE_DIRS="/opt/spack_views/niklas/include"
