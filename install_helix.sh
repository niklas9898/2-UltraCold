...
cmake -DULTRACOLD_WITH_CUDA=ON -DCMAKE_CUDA_ARCHITECTURES="all-major" -DCMAKE_C_COMPILER=gcc -DCMAKE_CXX_COMPILER=g++ -DCMAKE_Fortran_COMPILER=gfortran -DWHICH_CLUSTER="helix" -DCMAKE_INSTALL_PREFIX=. ..
